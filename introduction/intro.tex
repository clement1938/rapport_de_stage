...
Mon maître de stage, Carlos MONTILLA, est responsable d'Antares depuis dix mois. Il a notamment fortement contribué au traitement \ac{FWH}. La chaîne de calcul aéroacoustique utilise le traitement d'interpolation avant de pouvoir utiliser le traitement FWH (voir \ref{s243}).
