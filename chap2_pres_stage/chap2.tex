...
\begin{center}
    \begin{tikzpicture}
        ...
        \fill[green!20, opacity=0.6] (III) -- (P) -- (IV) -- cycle;
        \fill[red!20, opacity=0.6] (P) -- (III) -- (II) -- cycle; % Cette surface sera considérée comme négative
...
L'idée est de créer une base source avec une variable linéaire et une base cible avec des points décalés. Ensuite on test l'interpolation retourne bien la valeur analytique espérée sur tous les types de cellules. Ce test est effectué très simplement avec une commande dans le terminal ou lors d'un git push vers Nitrox.
