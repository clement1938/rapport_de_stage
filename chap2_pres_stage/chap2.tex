...
\centering
    ...
    \end{tikzpicture}
\caption{Comment savoir si une surface créé par deux sommets et un point est dans un triangle}
\label{fig:find_sn}
\end{figure}

La surface bleu est à l’extérieur, ce qui est vérifié par le fait que le point P ne se situe pas du même coté de la droite (AC) que le point B.
