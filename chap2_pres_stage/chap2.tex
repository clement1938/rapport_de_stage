...
Certains industriels utilisent de plus en plus des polygones à N arrêtes. Mais par soucis de simplicité, l'interpolation linéaire se limite aux 3 principales cellules, les polygones pouvant être décomposés en triangles. % https://team.inria.fr/titane/files/2019/12/barycentric.pdf et https://www.inf.usi.ch/hormann/papers/Hormann.2014.BI.pdf  décris l'interpolation barycentrique généralisée
...
Un point qui me perturbait était de faire des multiplications de surfaces, donc relevant d'une équation d'ordre 4, dans une méthode linéaire.
