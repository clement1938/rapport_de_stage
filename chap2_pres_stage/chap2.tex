...
L'interpolation linéaire, est la plus simple (après les plus proches voisins et IDW), et la plus utilisée par Airbus, Safran et d'autres industriels (dans via d'autres codes qu'Antares).
Elle est appelée interpolation Barycentrique dans le cas où la forme source est un triangle, bilinéaire dans le cas 2D où le maillage est structuré et trilinéaire dans le cas où le maillage est 3D et structuré.
