...
L'interpolation consiste à déterminer la valeur de nouveaux points à partir de la valeur de points existants. En voici un exemple en une dimension (l'axe x représente la position et l'axe y l valeur des points)
...
\begin{tikzpicture}
    ...
    \addlegendentry{Points existants}
...
\begin{tikzpicture}
    ...
    \addlegendentry{ Interpolation par voisin le plus proche}
