...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \node at (-1.5, -0.5) {(a) Base source (2D)};
            ...
            \node at (2.5, -0.5) {(b) Base cible (2D)};
            ...
            \foreach \angle in {0,45,...,315} {
                \fill[green] ({6.5 + 1*cos(\angle)},{1.5 + 1*sin(\angle)}) circle (2pt);
            }

            \node at (6.5, -0.5) {(c) Iterpolation (2D)};
            ...
            % Adding the legend with colored points
            \fill[red] (-2.5, -1.3) circle (2pt);
            \node at (-0.4, -1.3) {\textbf{Variable source}};
        
            \fill[blue] (-2.5, -1.7) circle (2pt);
            \node at (1.5, -1.7) {\textbf{Emplacement sans variabls définie}};
        
            \fill[green] (-2.5, -2.1) circle (2pt);
            \node at (-0.0, -2.1) {\textbf{Variable interpolée}};
